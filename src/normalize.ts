...
const TOOL_PARAMS = {
  ...
  properties: {
    ...
    consignee: { type: ["string", "null"], description: "receiving party" },
    shipper: { type: ["string", "null"], description: "sending party / consignor" },
    reference_po: { type: ["string", "null"], description: "customer PO or shipper reference" },
    secondary_id: { type: ["string", "null"], description: "house BL when entity_id is the master BL" },
